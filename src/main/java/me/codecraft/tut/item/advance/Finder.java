...
import me.codecraft.tut.util.ModTags;
...
public class Finder extends Item {
    ...
    private void addNbtToDataTablet(PlayerEntity player, BlockPos pos, Block blockBelow) {
        ItemStack dataTablet =
                player.getInventory().getStack(getFirstInventoryIndex(player, ModItem.DATA_TABLET));
    ...
    private boolean hasPlayerDataTablet(PlayerEntity player) {
        return hasPlayerStackInInventory(player, ModItem.DATA_TABLET);
    }
    ...
    private boolean isValuableBlock(Block block) {
        return block.getDefaultState().isIn(ModTags.Blocks.OP_ORES);
    }
